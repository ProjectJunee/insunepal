...
const LifeInsuranceQuote = () => {
  ...
  const handleSubmit = () => {
    ...
    setTimeout(() => {
      ...
      alert(
        "Quote request submitted! You will receive your personalized quote via email within 24 hours."
      );
    }, 2000);
  };
  ...
  const getEstimatedPremium = () => {
    ...
    if (age < 25)
      return Math.round((coverage / 100000) * 15 * genderMultiplier);
    if (age < 35)
      return Math.round((coverage / 100000) * 20 * genderMultiplier);
    if (age < 45)
      return Math.round((coverage / 100000) * 30 * genderMultiplier);
    if (age < 55)
      return Math.round((coverage / 100000) * 50 * genderMultiplier);
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-white">
              ...
              <p className="text-xl mb-8 text-teal-100">
                ...
                required. Secure your family's financial future with coverage
                starting at just Rs 1000/month.
              </p>
                  ...
                  <div className="bg-gradient-to-r from-teal-50 to-green-50 p-4 rounded-lg border border-teal-200">
                    <div className="text-center">
                      ...
                      <p className="text-xs text-gray-500 mt-1">
                        *Estimate based on age and coverage. Final rates may
                        vary.
                      </p>
                    </div>
                  </div>
